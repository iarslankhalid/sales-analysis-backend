...
:: Run the check_filepath.py script to validate the FILE_PATH
echo Checking the given path in .env file...
%PYTHON_EXE% .\app\utils\check_filepath.py

:: If the check_filepath.py script did not raise an error, proceed
